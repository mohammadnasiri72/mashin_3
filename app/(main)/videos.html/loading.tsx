          ...
          <div className="lg:w-3/4 w-full">
            ...
            <div className="px-2">
              <div className="space-y-6 bg-white rounded-2xl p-3 shadow-lg border border-gray-100">
                <div className="flex sm:flex-nowrap flex-wrap items-center gap-2 animate-pulse">
                ...
                <div className="flex flex-wrap">
                  {[...Array(6)].map((_, index) => (
                    <div
                      key={index}
                      className="p-2 sm:w-1/2 lg:w-1/3 w-full animate-pulse"
                    >
                      <div className="group bg-gray-50 rounded-xl border-2 border-gray-200">
