...
function HeroSectionAutoService({ detailsAuto }: { detailsAuto: ItemsId }) {
  return (
    <>
      <section
          ...
          <div className="text-white! sm:w-auto w-full">
            ...
            <nav className="mt-6 sm:block hidden">
              <ol className="flex items-center space-x-2 space-x-reverse flex-wrap">
                ...
                {detailsAuto.breadcrumb &&
                  detailsAuto.breadcrumb.length > 0 &&
                  detailsAuto.breadcrumb.map((b) => (
                    <li key={b.href}>
...
export default HeroSectionAutoService;
