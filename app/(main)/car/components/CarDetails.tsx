              ...
              <div className="relative group">
                ...
                <div className="absolute lg:left-full lg:translate-x-0 -translate-y-1 lg:translate-y-0 lg:top-0 lg:mr-3 lg:space-y-3 z-10 lg:z-0 flex lg:block sm:flex-row flex-col lg:py-0 py-2 lg:px-0 px-1 gap-3">
                  ...
                  >
                    ...
                    <span className="sm:inline hidden">مقایسه کنید</span>
                  </Link>
                  <div
                    onClick={() => {
                      handleLike(detailsCar.id);
                    }}
                    className="bg-[#ce1a2a] cursor-pointer text-white! px-4 py-2 text-xs text-center whitespace-nowrap h-8 w-auto!"
                  >
                    <FaHeart className="inline ml-1" />
