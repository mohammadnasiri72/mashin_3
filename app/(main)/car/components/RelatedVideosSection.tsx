...
function RelatedVideosSection({ relatedVideos , detailsCar}: { relatedVideos: Items[] , detailsCar:ItemsId}) {
  return (
    <>
                  ...
                  <div className="bg-gray-100 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                    <div className="aspect-video relative">
                      <img
                        ...
                        className="w-full h-full object-cover group-hover:scale-105 transition-transform overflow-hidden"
                      />
