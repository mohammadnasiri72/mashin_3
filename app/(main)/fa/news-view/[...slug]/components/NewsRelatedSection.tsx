    ...
    <>
      <section className="sm:px-5 px-2 py-5 bg-white rounded-xl shadow-sm">
        <h3 className="dt_title text-xl font-bold text-gray-900 mb-5!">
          <strong className="text-[#ce1a2a]!">اخبار </strong>
          مرتبط
        </h3>
        <div className="">
          {relatedNews.map((news, index) => (
            <Link
              key={news.id}
              href={news.url}
              className={`group flex items-center gap-4 p-2  hover:bg-gray-50/80 transition-all duration-300 ${
            ...
            >
              ...
              {/* Arrow Icon */}
              <div className="lg:block hidden shrink-0 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
