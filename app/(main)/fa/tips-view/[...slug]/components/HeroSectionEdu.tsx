...
function HeroSectionEdu({ education }: { education: ItemsId }) {
  return (
    <>
      <section
          ...
          <div className="text-white! sm:w-auto w-full">
            ...
            <nav className="mt-6">
              <ol className="flex items-center space-x-2 space-x-reverse flex-wrap">
                ...
                {education.breadcrumb &&
                  education.breadcrumb.length > 0 &&
                  education.breadcrumb.map((b) => (
                    <li key={b.href}>
            ...
            <div className="flex items-center gap-4 mt-2 text-sm text-gray-600 flex-wrap px-2">
                             ...
                             <div className="flex items-center gap-1">
                               ...
                               <span className="font-bold text-white! text-xs">
                                 {formatPersianDate(education.created)}
                               </span>
                             </div>
                           </div>
          </div>
