      ...
      <div className="mx-auto px-4">
        ...
        <header className="flex sm:flex-row flex-col justify-between items-center mb-4">
          <div className="mb-2! sm:w-auto w-full p-3 sm:bg-transparent bg-[#f6eced] rounded-xl flex sm:justify-start justify-center items-center">
            <h2 id="news-list-title" className="pb-0! mb-0! text-[#292929]! font-bold! inline-block relative pl-2.5 text-[22px] z-10 after:content-[''] after:absolute after:left-0 after:right-0 after:bottom-0 after:h-1/2 after:-z-10 sm:after:bg-[#ffd6db]">
              لیست اخبار
            </h2>
          </div>
